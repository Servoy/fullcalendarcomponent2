{
	...
	"model":
	{
		...
		"themeSystem" : { "type" :"string", "tags": { "scope" :"design" }, "default": "standard", "values" :["standard", "bootstrap5", "classic", "breezy", "forma", "monarch", "pulse"]},
	...
	"types": {
        ...
        "FullCalendarOptions" : {
			...
			"slotHeaderFormat": {"type" :"string", "tags": {"doc" : "Determines the text that will be displayed within a time slot."}},
			"slotHeaderInterval": {"type" :"object", "tags": {"doc" : "The frequency that the time slots should be labelled with text."}},
			...
			"tableHeaderSticky": {"type": "object", "tags": {"doc" : "Whether to fix the date-headers at the top of the calendar to the viewport while scrolling."}},
			...
			"slotHeaderDidMount": {"type": "object", "tags": {"doc" : "Callback called right after the element is added to the DOM."}},
			"slotHeaderWillUnmount": {"type": "object", "tags": {"doc" : "Callback called right before the element will be removed from the DOM."}},
